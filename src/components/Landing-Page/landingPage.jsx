  ...
  return (
    <>
      ...
      >
        ...
        <PenLine size={16} color="darkgray" style={{ marginRight: 6 }} />
        ...
        {!collapsed && (
          <>
            <div className={styles.appIcon}>
              ꔰ <span className={styles.appTitle}>RNotion's Challenge</span>
            </div>
            ...
            <a
                href="https://rnotion-questions.vercel.app/5e314bf3a4f39a51736d66acc5a259059e3f11263af328eec622c2ab9b413b4d" // Alhaan Questions
            ...
            <nav className={styles.navSection}>
              <span className={styles.sectionTitle}>Available Challenges</span>
              <ul>
                {navTree.map((n) => (
                  <NavItem
                    key={n.label}
